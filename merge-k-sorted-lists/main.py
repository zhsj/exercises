    ...
    def mergeTwo(self, ListNode1, ListNode2):
        ...
        while ListNode1 and ListNode2:
            if ListNode1.val < ListNode2.val:
                sorted_list.append(ListNode1.val)
                ListNode1 = ListNode1.next
            else:
                sorted_list.append(ListNode2.val)
        ...
        while ListNode2:
            sorted_list.append(ListNode2.val)
            ListNode2 = ListNode2.next
        return self.make_list(sorted_list)

    def make_list(self, l):
...
if __name__ == '__main__':
    solution = Solution();
    x1 = solution.make_list([1,4,7,8])
    x2 = solution.make_list([2,3,5,7])
